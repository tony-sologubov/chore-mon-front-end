...
class UserProfile extends React.Component {
  ...
  add = (m, props) => {
    axios
      .post(`https://tonys-demo-backend.herokuapp.com/api/groupmembers`, m)
      .then(res => {
        console.log(res);
      })
  ...
  addFriend = (e, uid, friendId) => {
    ...
    axios
      .post("https://tonys-demo-backend.herokuapp.com/api/friends", friend1)
      .then(
        axios
          .post("https://tonys-demo-backend.herokuapp.com/api/friends", friend2)
